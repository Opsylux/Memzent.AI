...
const Pricing = () => (
  <section id="pricing" className="py-40 px-6 max-w-7xl mx-auto">
    <div className="text-center mb-20">
      <h2 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 underline decoration-memzent-glow underline-offset-8">PRICING CLUSTERS</h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {[
        ...
        <div key={plan.name} className={`p-10 rounded-[40px] glass flex flex-col items-start gap-8 border-white/5 transition-all hover:border-memzent-glow/20 ${plan.highlight ? 'bg-memzent-glow/5 border-memzent-glow/20 scale-105 z-10' : ''}`}>
          ...
          <ul className="space-y-4 flex-1">
            {plan.features.map(f => (
              <li key={f} className="flex gap-3 text-sm font-bold opacity-70">
                <Check size={16} className="text-memzent-glow" /> {f}
              </li>
            ))}
          </ul>
          <a
            href={appUrl + "/login"}
            className={`w-full py-5 rounded-2xl text-center text-sm font-black uppercase tracking-[0.2em] transition-all ${plan.highlight ? 'bg-memzent-glow text-black shadow-[0_0_20px_rgba(0,243,255,0.3)]' : 'bg-white text-black hover:bg-memzent-glow'
              }`}
          >
            {plan.cta}
          </a>
...
const Navbar = () => (
  <nav className="fixed top-0 left-0 right-0 z-50 glass px-6 py-4 flex justify-between items-center m-4 rounded-2xl">
    <div className="flex items-center gap-2">
      <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-memzent-glow to-memzent-purple flex items-center justify-center">
    ...
    <div className="hidden md:flex gap-8 text-sm font-medium opacity-70">
      ...
      <a href="#pricing" className="hover:text-memzent-glow transition-colors">Pricing</a>
    </div>
    <div className="flex gap-4">
      ...
      <a href={appUrl + "/login"} className="bg-white text-black text-sm font-black px-6 py-2 rounded-xl hover:bg-memzent-glow hover:scale-105 transition-all cursor-pointer shadow-[0_0_20px_rgba(255,255,255,0.1)]">Get Started</a>
    </div>
  </nav>
);
...
const Hero = () => (
  <section className="relative pt-40 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
    ...
    >
      THE SECURE<br />
      <span className="text-transparent bg-clip-text bg-gradient-to-r from-memzent-glow via-memzent-purple to-memzent-accent">AI BACKBONE</span>
    </motion.h1>
    ...
    >
      Memzent is an AI gateway designed for massive scale. Secure every prompt,
    ...
    <div id="observability" className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center md:flex-row-reverse">
      <div className="order-1 md:order-2">
        ...
        <div className="p-6 glass rounded-2xl border-memzent-glow/20 font-mono text-sm space-y-2">
          ...
          <div className="flex justify-between text-memzent-glow opacity-80"><span>TOKEN_FLOW</span> <span>1.2M/min</span></div>
    ...
    <div id="roi" className="text-center space-y-8 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass p-8 rounded-3xl border-memzent-accent/20">
          <div className="text-4xl font-black text-memzent-accent mb-2">98%</div>
          <div className="text-xs font-bold uppercase opacity-40">Cache Hit Rate</div>
        </div>
        <div className="glass p-8 rounded-3xl border-memzent-accent/20">
          <div className="text-4xl font-black text-memzent-accent mb-2">-15ms</div>
          <div className="text-xs font-bold uppercase opacity-40">Latency Impact</div>
        </div>
        <div className="glass p-8 rounded-3xl border-memzent-accent/20">
          <div className="text-4xl font-black text-memzent-accent mb-2">$0.00</div>
  ...
  <footer className="pt-40 pb-10 px-6 border-t border-white/5">
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-20 text-sm opacity-40 font-medium tracking-tight">
      <div className="col-span-2">
        <div className="flex items-center gap-2 mb-4 opacity-100 italic font-black text-xl">MEMZENT.ai</div>
        <p className="max-w-sm">Project Memzent: Modern AI infrastructure for security, scale, and efficiency.</p>
      </div>
      <div className="space-y-3">
        <div className="font-black text-white mb-4">PLATFORM</div>
        <a href="#" className="block hover:text-memzent-glow">Gateway API</a>
        <a href="#" className="block hover:text-memzent-glow">Semantic Router</a>
        <a href="#" className="block hover:text-memzent-glow">Monitoring</a>
      </div>
      <div className="space-y-3">
        <div className="font-black text-white mb-4">LEGAL</div>
        <a href="#" className="block hover:text-memzent-glow">Compliance</a>
        <a href="#" className="block hover:text-memzent-glow">Security Audit</a>
        <a href="#" className="block hover:text-memzent-glow">ROI Calculator</a>
      </div>
    </div>
  </footer>
);
