  ...
  return (
    ...
    >
      ...
      <div className="space-y-1">
        <h3 className="text-sm font-bold text-white/75 uppercase tracking-widest leading-none">{label}</h3>
        <div className="text-4xl font-black tracking-tighter text-white">{value}</div>
      </div>

      <div className="mt-6 flex items-center justify-between">
        <span className="text-[10px] font-mono font-bold text-white/55 uppercase tracking-tighter">{detail}</span>
