...
export default async function AdminNodesPage() {
   ...
   const stats = await getMemzentStats(org?.orgId); // Scoped to admin org to prevent Forbidden crash
   ...
   return (
      <div className="space-y-12 pb-20">
         <div className="flex items-center gap-4 mb-4">
            <div className="w-2 h-8 rounded-full bg-gradient-to-b from-memzent-purple to-memzent-accent" />
            <div>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="stat-card p-8 neural-bg border-white/5 space-y-6">
               <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-memzent-glow/10 border border-memzent-glow/20 flex items-center justify-center text-memzent-glow">
                     <Server size={24} />
                  </div>
               ...
               <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/5">
                     <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-bold text-white">memzent-gateway</span>
                     </div>
                     <span className="text-[9px] font-black text-memzent-accent px-2 py-1 rounded-md bg-memzent-accent/10 border border-memzent-accent/20">HEALTHY</span>
                  </div>
                  <div className="flex items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/5">
                     <div className="flex items-center gap-3">
                        <Terminal size={14} className="text-memzent-purple" />
                        <span className="text-xs font-bold text-white">memzent-router (rust)</span>
                     </div>
                     <span className="text-[9px] font-black text-memzent-accent px-2 py-1 rounded-md bg-memzent-accent/10 border border-memzent-accent/20">HEALTHY</span>
                  </div>
                  <div className="flex items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/5">
                     <div className="flex items-center gap-3">
                        <Terminal size={14} className="text-memzent-glow" />
                        <span className="text-xs font-bold text-white">memzent-qdrant</span>
                     </div>
                     <span className="text-[9px] font-black text-memzent-accent px-2 py-1 rounded-md bg-memzent-accent/10 border border-memzent-accent/20">HEALTHY</span>
                  </div>
               </div>
            ...
            <div className="stat-card p-8 neural-bg border-white/5 space-y-6">
               ...
               <div className="flex flex-col items-center justify-center p-12 text-center space-y-4">
                  ...
                  <div className="w-1.5 h-1.5 rounded-full bg-memzent-accent animate-pulse" />
               </div>
            </div>
         </div>
      </div>
