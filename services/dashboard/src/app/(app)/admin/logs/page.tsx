  ...
  return (
    <div className="h-[calc(100vh-120px)] flex flex-col space-y-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-4">
           <div className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-aura-glow animate-pulse" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
         <div className="p-4 rounded-2xl bg-aura-purple/5 border border-aura-purple/10 flex items-center justify-between group hover:border-aura-purple/30 transition-all">
            ...
            <span className="text-[10px] font-black text-aura-purple italic">30 DAYS (Active)</span>
         </div>
         <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5 flex items-center justify-between">
            <div className="flex items-center gap-3">
               <Terminal size={16} className="text-aura-glow/40" />
               <span className="text-[10px] font-black text-white/60 uppercase tracking-widest">Persistence</span>
            </div>
            <span className="text-[10px] font-black text-aura-glow italic uppercase">Postgres Hardened</span>
         </div>
         <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5 flex items-center justify-between">
            <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-black text-aura-accent italic uppercase tracking-tighter animate-pulse">Live polling...</span>
         </div>
      </div>
    </div>
  );
