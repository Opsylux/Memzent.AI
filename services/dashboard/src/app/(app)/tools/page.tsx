                ...
                <tr key={tool.id} className="border-b border-white/5 hover:bg-white/[0.03] transition-all group">
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/20 group-hover:text-memzent-glow transition-colors">
                        <Database size={18} />
                      </div>
                      <div>
                  ...
                  <td className="px-8 py-6 text-[10px] font-bold">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-memzent-accent/60 uppercase">ONLINE</span>
                    </div>
                  </td>
