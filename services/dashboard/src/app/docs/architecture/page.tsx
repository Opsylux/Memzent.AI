    ...
    <div className="space-y-14">
      <header className="space-y-4">
        <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-aura-glow/5 border border-aura-glow/20 w-fit">
          <span className="text-[10px] font-black text-aura-glow uppercase tracking-tighter italic">How_It_Works</span>
        </div>
        <h1 className="text-4xl font-black tracking-tighter uppercase sm:text-5xl">How Aura Works</h1>
        <p className="text-lg text-white/60 leading-relaxed font-medium max-w-2xl">
          Aura sits between your application and your AI models. It understands what your users are asking — not just the words they use — and intelligently routes every request to get the fastest, most accurate answer possible.
        </p>
      </header>
      ...
      <section className="space-y-6">
        ...
        <p className="text-sm text-white/60 leading-relaxed font-medium">
          Think of Aura as an intelligent concierge. Your app sends a question, and Aura handles everything: checking if the answer already exists, finding the right tools to gather context, and then synthesizing a response — all before returning a result to you.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 py-6 overflow-x-auto">
          {[
            ...
            <div key={node.label} className="flex items-center gap-2 shrink-0">
              <div className={`px-4 py-2 rounded-xl text-xs font-black uppercase tracking-tight border ${
                node.label === "Aura Gateway"
                  ? "bg-aura-glow/10 border-aura-glow/30 text-aura-glow shadow-[0_0_20px_rgba(0,243,255,0.08)]"
      ...
      <section className="space-y-6">
        ...
        <p className="text-sm text-white/60 leading-relaxed font-medium">
          Every time your application sends a prompt, Aura follows a deliberate sequence to maximize speed, accuracy, and cost efficiency.
        </p>
          ...
          {[
            {
              ...
              desc: "Aura verifies who is making the request and confirms they have permission to access the tools and models they need. Unauthorized requests are stopped before any work begins."
            },
            {
              icon: <Search size={16} />,
              ...
              desc: "Aura checks its semantic memory. If a similar question was already answered — even if worded differently — the cached response is returned instantly. No model call, no cost, zero wait."
            },
            {
              icon: <Layers size={16} />,
              ...
              desc: "Aura understands the intent behind the question and identifies which of your connected tools — databases, APIs, knowledge bases — can provide the most relevant context."
            },
            {
            ...
            },
            {
              ...
              desc: "The enriched prompt is sent to the AI model of your choice. Because Aura already gathered the relevant context, the model produces a more accurate, grounded response — using fewer tokens."
            },
            {
              icon: <Zap size={16} />,
              color: "text-aura-accent",
              ...
              desc: "The answer is returned to your app and saved in Aura's semantic memory. The next time someone asks something similar, they get an instant response — from any provider, any region."
            },
          ].map((item) => (
            <div
              key={item.step}
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 space-y-3">
            <div className="text-2xl font-black text-aura-glow">Sub-1ms</div>
          ...
          <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 space-y-3">
            <div className="text-2xl font-black text-aura-purple">Any Model</div>
            <div className="text-xs font-black uppercase tracking-tight">One unified API</div>
            <p className="text-[11px] text-white/40 leading-relaxed font-bold">
              Switch between AI providers without changing your application code. Aura handles all provider details.
            </p>
          </div>
          <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 space-y-3">
            <div className="text-2xl font-black text-aura-accent">Live Tools</div>
