    ...
    <div className="space-y-12">
      <header className="space-y-4">
        ...
        <p className="text-lg text-white/60 leading-relaxed font-medium">
          Memzent gives you fine-grained control over what each user and API key can access — scoped to your organization and down to individual tools.
        </p>
      </header>
      ...
      <section className="space-y-5">
        ...
        <p className="text-sm text-white/60 leading-relaxed font-medium">
          Every permission in Memzent belongs to a specific organization. A user who is an Admin in one organization has no special access in another — even if they are a member of both.
        </p>
        <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/5 space-y-4">
          ...
          <div className="space-y-2 text-[11px] text-white/40 font-bold">
            <div className="flex gap-3"><span className="text-memzent-glow shrink-0">Organization</span><span>→ contains Members, each with a Role</span></div>
            <div className="flex gap-3"><span className="text-memzent-purple shrink-0">Role (Admin/Member)</span><span>→ controls what actions are allowed</span></div>
            <div className="flex gap-3"><span className="text-memzent-accent shrink-0">Tool Gating</span><span>→ further restricts which tools can be called</span></div>
          </div>
        </div>
      </section>
        ...
        <div className="space-y-4">
          <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 space-y-5">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-memzent-glow/10 flex items-center justify-center text-memzent-glow">
                <Lock size={14} />
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={text} className="flex items-start gap-2">
                  <CheckCircle2 size={13} className="text-memzent-glow shrink-0 mt-0.5" />
      ...
      <section className="space-y-5 pt-2">
        ...
        <div className="p-5 rounded-2xl bg-memzent-purple/5 border border-memzent-purple/10 flex items-start gap-4">
          <Settings size={18} className="text-memzent-purple mt-0.5 shrink-0" />
          <div className="space-y-2">
            ...
            <p className="text-[11px] text-white/40 font-bold leading-relaxed">
              When registering a tool, set <code className="text-memzent-purple bg-memzent-purple/10 px-1 rounded font-mono">requires_auth: true</code> to gate it behind permissions. Open tools that anyone should be able to use (like search) can be set to <code className="text-memzent-purple bg-memzent-purple/10 px-1 rounded font-mono">requires_auth: false</code>.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-wrap gap-4 pt-4 border-t border-white/5">
        <Link href="/docs/rbac" className="text-xs text-memzent-glow font-black uppercase tracking-widest hover:underline">
